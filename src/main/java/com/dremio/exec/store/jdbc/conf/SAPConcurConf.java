...
@SourceType(value = "SAPConcurARP", label = "SAPConcur",uiConfig = "sapconcur-layout.json")
public class SAPConcurConf extends AbstractArpConf<SAPConcurConf> {
  private static final String ARP_FILENAME = "arp/implementation/sapconcur-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.sapconcur.SAPConcurDriver";
